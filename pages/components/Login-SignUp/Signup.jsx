...
export default function Signup() {
  return (
    <div className="animate__animated animate__bounceInDown  shadow-2xl flex flex-col justify-center items-center rounded-lg border-2 border-brand-color w-2/5 h-3/5 p-5">
      <h1 className="px-2 text-2xl font-bold text-brand-color ">Sign up</h1>
      <p className="text-brand-color">Sign up with Email</p>
      ...
      <form className="flex flex-col w-full h-2/5  mt-4">
        ...
        <div className="flex flex-row justify-between items-stretch">
          <div className=' pt-1 pl-1  my-1 border-2 border-brand-color-2 rounded-lg'>
            <label className="text-brand-color font-bold" for='firstName'>First Name</label>
            <input id='firstName' type='text' className="w-full focus:outline-none px-1 mb-1" placeholder="Type your First Name..." />
          </div>

          <div className='pt-1 pl-1  my-1 border-2  border-brand-color-2 rounded-lg'>
            <label className="text-brand-color font-bold" for='lastName'>Last Name</label>
            <input id='lastName' type='text' className="w-full focus:outline-none px-2 mb-1" placeholder="Type your Last Name..." />
          </div>
        </div>
      </form>
      ...
      <button className="rounded-lg bg-brand-color w-5/6 h-12 mt-2 text-white font-bold uppercase">Sign Up</button>
      <div className="flex justify-center mt-2 w-5/6">
        <p>Already have an account?
          <Link href="/login"><a className="text-brand-color-2 hover:text-brand-color "> Login now</a></Link>
        </p>
      </div>
